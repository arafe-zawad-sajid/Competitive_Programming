...
public class Main {
	...
	public static String checkName(HashMap<String, Integer> db, String input) {
		int c = db.getOrDefault(input, 0);
		if(c == 0) {
			db.put(input, 1);
			return "OK";
		}
	...
	public static void main(String[] args) {
	    ...
	    while(t-- > 0) {
	    	...
	    	System.out.println(checkName(db, input));
	    }
